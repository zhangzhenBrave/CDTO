...
def generate_random_placement(net_len, task_num, n_devices, allow_device_0=True):
    placement = []
...
def apply_placement(net_len, placement, task_num):
    net=placement.reshape(net_len, task_num)
