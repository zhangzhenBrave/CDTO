...
def _evaluate(individual, net_len, task_num, task_iner_priority, device_graph, task_unit, pipeline_batches=1, batches=1, simulator_comp_penalty=1,
              simulator_comm_penalty=1, device_memory_utilization=1):
    print('task_iner_priority',task_iner_priority)
    return 1 / evaluate_placement(apply_placement(net_len, individual.placement, task_num),task_iner_priority, device_graph, task_unit,
    ...
    def optimize(self, net_len, task_num,n_devices,task_iner_priority, device_graph, task_unit):
        ...
        def initialize(population_size):
            ...
            while len(placements) < population_size:
                placements.append(generate_random_placement(net_len, task_num, n_devices, allow_device_0=self.allow_cpu))
        ...
        def evaluate(individual):
            return _evaluate(individual, net_len, task_num, task_iner_priority, device_graph, task_unit,
